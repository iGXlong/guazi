...
public class UserDaoImp implements BaseUserDao {
    private static final String SQL_CREATE_TABLE = "CREATE TABLE web_user(id INT PRIMARY KEY AUTO_INCREMENT,username VARCHAR(32),PASSWORD VARCHAR(32) NOT NULL,phonenumber VARCHAR(32) UNIQUE,flag INT,createtime DATETIME,logintime DATETIME)";
    ...
    private static final String SQL_UPDATE_LOGINTIME = "update web_user set logintime=now() where phonenumber=?";
    ...
    static {
        ...
        try {
            ...
            resultSet = metaData.getTables(null, null, "web_user", null);
            if (!resultSet.next()) {
