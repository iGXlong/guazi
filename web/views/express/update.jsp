...
<div id="app">
    ...
    <div class="content content2" style="display:none">
        <table>
            ...
            <tr>
                <td class="text-right">快递状态</td><td class="content_right"><input type="radio" disabled onclick="layer.msg('不允许修改快递状态')" name="status">已签收  <input disabled name="status" onclick="layer.msg('不允许修改快递状态')"  type="radio">未签收</td>
            </tr>
            <tr>
