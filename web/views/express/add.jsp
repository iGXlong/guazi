            ...
            <form class="layui-form layui-card-body" action="">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        ...
                        <input onclick="add()" type="button" class="layui-btn layui-btn-blue" value="立即提交">
...
<script>
    function add(){
        ...
        // 发送ajax , 将用户输入的快递信息, 发送到服务器的servlet中
        $.post("../../express/insert.do","number="+number+"&company="+company+"&name="+name+"&phone="+phone,function(data){
            //data服务器回复的内容
            layer.closeAll();
            //{"result":"ok|error"}
            if(data.result == "ok"){
