...
<div id="app">
    ...
    <div class="content content2" style="display:none">
        <table>
            ...
            <tr>
                <td class="text-right">快递状态</td><td class="content_right"><input readonly disabled type="radio" name="status">已签收  <input disabled readonly name="status" type="radio">未签收</td>
            </tr>
            <tr>
